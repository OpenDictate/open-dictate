...
class DictationForegroundService : Service() {
    ...
    companion object {
        const val ACTION_START = "com.openwispr.app.action.START_DICTATION"
        const val ACTION_START_TRANSFORMATION =
            "com.openwispr.app.action.START_TEXT_TRANSFORMATION"
        const val ACTION_STOP = "com.openwispr.app.action.STOP_DICTATION"
        const val ACTION_CANCEL = "com.openwispr.app.action.CANCEL_DICTATION"
