...
val appVersionName = providers.gradleProperty("appVersionName").orElse("0.6.0-rc.2")
val appVersionCode = providers.gradleProperty("appVersionCode").map(String::toInt).orElse(14)
