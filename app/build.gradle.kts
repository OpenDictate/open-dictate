...
val appVersionName = providers.gradleProperty("appVersionName").orElse("0.7.3")
val appVersionCode = providers.gradleProperty("appVersionCode").map(String::toInt).orElse(28)
