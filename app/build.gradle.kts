...
val appVersionName = providers.gradleProperty("appVersionName").orElse("0.7.5-rc.1")
val appVersionCode = providers.gradleProperty("appVersionCode").map(String::toInt).orElse(31)
