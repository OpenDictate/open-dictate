...
val appVersionName = providers.gradleProperty("appVersionName").orElse("0.7.2")
val appVersionCode = providers.gradleProperty("appVersionCode").map(String::toInt).orElse(27)
