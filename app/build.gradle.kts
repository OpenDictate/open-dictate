...
val appVersionName = providers.gradleProperty("appVersionName").orElse("0.6.6-rc.1")
val appVersionCode = providers.gradleProperty("appVersionCode").map(String::toInt).orElse(22)
