...
val appVersionName = providers.gradleProperty("appVersionName").orElse("0.6.4")
val appVersionCode = providers.gradleProperty("appVersionCode").map(String::toInt).orElse(20)
