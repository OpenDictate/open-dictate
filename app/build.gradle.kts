...
val appVersionName = providers.gradleProperty("appVersionName").orElse("0.9.1")
val appVersionCode = providers.gradleProperty("appVersionCode").map(String::toInt).orElse(35)
