...
val appVersionName = providers.gradleProperty("appVersionName").orElse("0.8.0")
val appVersionCode = providers.gradleProperty("appVersionCode").map(String::toInt).orElse(32)
